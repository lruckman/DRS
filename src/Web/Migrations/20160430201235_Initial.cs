...
namespace web.Migrations
{
    public partial class Initial : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema("Lookup");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryDocument", x => new { x.LibraryId, x.DocumentId });
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("DocumentContents");
            migrationBuilder.DropTable("Files");
            migrationBuilder.DropTable("LibraryDocuments");
            migrationBuilder.DropTable(name: "StatusTypes", schema: "Lookup");
