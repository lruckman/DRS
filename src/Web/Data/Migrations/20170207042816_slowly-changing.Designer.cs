...
namespace Web.data.migrations
{
    ...
    [Migration("20170207042816_slowly-changing")]
    partial class slowlychanging
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Web.Models.Metadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("DocumentId", "VersionNum");
            ...
            modelBuilder.Entity("Web.Models.Metadata", b =>
                {
                    b.HasOne("Web.Models.File", "File")
                        .WithMany("Metadata")
                        .HasForeignKey("DocumentId", "VersionNum")
                        .OnDelete(DeleteBehavior.Cascade);
                });
